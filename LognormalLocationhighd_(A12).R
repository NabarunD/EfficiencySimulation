...
xval=seq(-0.25,-0.01,0.1)
df1=data.frame(x=xval,y=pava(st[2,],dec=T),test = "1")
df2=data.frame(x=xval,y=pava(st[5,],dec=T),test = "2")
df3=data.frame(x=xval,y=pava(st[8,],dec=T),test = "3")
df4=data.frame(x=xval,y=pava(st[3,],dec=T),test = "4")
df5=data.frame(x=xval,y=pava(st[6,],dec=T),test = "5")
df6=data.frame(x=xval,y=pava(st[9,],dec=T),test = "6")
par(bg="grey")
